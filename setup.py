...
if sys.platform == 'darwin':
    ...
    os.environ['CFLAGS']   = '-DGGML_USE_OPENBLAS -I/usr/local/include/openblas -mcpu=neoverse-n1 -march=armv8-a+fp+simd -O3 -std=gnu11 -mfpu=neon-fp-armv8 -mfp16-format=ieee -mno-unaligned-access'
    os.environ['CXXFLAGS'] = '-DGGML_USE_OPENBLAS -I/usr/local/include/openblas -mcpu=neoverse-n1 -march=armv8-a+fp+simd -O3 -std=c++11 -mfpu=neon-fp-armv8 -mfp16-format=ieee -mno-unaligned-access'
    os.environ['LDFLAGS']  = '-lopenblas -llapack -lgfortran'
